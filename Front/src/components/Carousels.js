  ...
  return (
    <Carousel id="main_carousels">
      <Carousel.Item>
        ...
        />
        <Carousel.Caption>
            <h4 style={TextShadow}><b>실력에서 오는 자신감</b></h4>
      ...
      <Carousel.Item>
        ...
        />
        <Carousel.Caption>
            <h4 style={TextShadow}><b>정확한 자세 분석</b></h4>
            <p style={TextShadow}>검증된 데이터만을 학습한 모델이 당신의 자세를 분석합니다.</p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
        <img
        ...
        />
        <Carousel.Caption>
            <h4 style={TextShadow}><b>UJS만의 랭킹제</b></h4>
