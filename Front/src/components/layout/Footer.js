            ...
            <Row>
                <Col sm={4}>
                    <ul className='d-flex justify-content-between text-center'>
                        ...
                        <Link to="/comparison"><li>스윙분석</li></Link>
                        <Link to="/commu"><li>커뮤니티</li></Link>
                        <Link to="/account"><li>내프로필</li></Link>
                    </ul>
                </Col>
                <Col sm={5}></Col>
                <Col sm={3}>
                    <img className="footer_icon" alt="github_logo" src="img/github.png" />
